...
# the deferred-import convention the gstreamer smokes use (moved to
# openral-pro). The
...
if __name__ == "__main__":
    ...
    # even when the round-trip succeeded (same os._exit workaround the
    # gstreamer smokes use, now in openral-pro).
    os._exit(rc)

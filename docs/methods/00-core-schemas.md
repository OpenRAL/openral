...
- `class PhysicsBackend(str, Enum)` — Sim backend. (L4690)
  `MUJOCO, MUJOCO_MJX, PYBULLET, SAPIEN, ISAACSIM, GENESIS, MOCK` (SAPIEN = ManiSkill3 / RoboTwin engine; the RoboTwin dual-arm backend uses it via a py3.10 sidecar — ADR-0061)

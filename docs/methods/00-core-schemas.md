...
- `class PhysicsBackend(str, Enum)` — Sim backend. (L4689)
  `MUJOCO, MUJOCO_MJX, PYBULLET, ISAACSIM, COPPELIASIM, GENESIS, MOCK`
  (`COPPELIASIM` = CoppeliaSim/PyRep RLBench backend, out-of-process py3.10 sidecar — ADR-0061)

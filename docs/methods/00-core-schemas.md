...
- `ReasonerToolCall: TypeAlias` — Discriminated union over the ten variants above (four actuation/effect + four ADR-0039/0043/0047 read-only query + the two ADR-0072 memory tools, one write + one read). Module docstring shows the encode/decode pattern.

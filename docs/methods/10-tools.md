...
- `refresh_file(md_path: Path, *, check: bool) -> tuple[int, list[str]]` — Rewrite one inventory file's markers; returns the changed-marker count and the unresolved-entry descriptions. (L183)

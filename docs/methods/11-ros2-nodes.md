...
- `generate_launch_description() -> LaunchDescription` (L2565) — Robot-agnostic deploy-sim launch graph entry point; wraps `compose_runtime_graph` in an `OpaqueFunction`.

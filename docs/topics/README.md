...
| `/octomap_binary` | `octomap_msgs/Octomap` | — | packages/openral_octomap_bridge/src/octomap_voxel_bridge_node.cpp [param `octomap_topic`] |
...
| `/openral/perception/{kind}` | `openral_msgs/PromptStamped` | python/runner/src/openral_runner/backends/gstreamer/perception_tee.py (PerceptionEventPublisher.start) | packages/openral_reasoner_ros/openral_reasoner_ros/reasoner_node.py (ReasonerNode.on_configure) |
...
| `{_controller_manager}/list_controllers` | `controller_manager_msgs/ListControllers` | — | python/hal/src/openral_hal/ros_control_transport.py (RosControlTransport.__init__) |
| `{_controller_manager}/switch_controller` | `controller_manager_msgs/SwitchController` | — | python/hal/src/openral_hal/ros_control_transport.py (RosControlTransport.__init__) |

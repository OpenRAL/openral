"""Shared ``sim_e2e.launch.py`` loader for this package's launch-graph tests.
...
normal ``from openral_rskill_ros.launch.sim_e2e import …`` is not available.
...
def import_launch_module(launch_file: Path) -> ModuleType:
    """Load ``launch_file`` (e.g. ``sim_e2e.launch.py``) as a Python module via importlib."""
    spec = importlib.util.spec_from_file_location("sim_e2e_launch", launch_file)

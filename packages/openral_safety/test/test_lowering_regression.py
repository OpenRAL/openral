...
# most capsules are clean round numbers (link5 = sphere r=0.060 at the origin)
# rather than PCA-fitted ones. Link7 deliberately reuses the generated
# franka_panda mesh envelope after the round capsule false-stopped intended
# contact in RoboCasa. The committed ACM was generated against the original hand geometry, so it
# carries the always-colliding

...
# its OBBs are derived from the compiled RoboCasa collision meshes rather than
# the standalone URDF. The committed ACM was generated against the original
# hand-authored capsule geometry, so it carries the always-colliding

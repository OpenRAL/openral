...
# rather than PCA-fitted ones. Link7 deliberately uses an OBB around the real
# RoboCasa collision mesh after the round capsule false-stopped intended
# contact. The committed ACM was generated against the original hand geometry,
# so it carries the always-colliding

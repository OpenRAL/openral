...
def test_tick_duration_records_histogram(
...
def test_safety_violations_counter(
    memory_metric_reader: InMemoryMetricReader,
    _find_metric: Callable[[InMemoryMetricReader, str], object | None],
) -> None:
...
def test_world_state_updown_counter(
    memory_metric_reader: InMemoryMetricReader,
    _find_metric: Callable[[InMemoryMetricReader, str], object | None],
) -> None:
...
def test_record_histogram_ms_skips_negatives(
    memory_metric_reader: InMemoryMetricReader,
    _find_metric: Callable[[InMemoryMetricReader, str], object | None],
) -> None:

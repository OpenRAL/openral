...
DEFAULT_SYSTEM_PROMPT: str = (
    ...
    "object you can point to in PERCEPTION — the scene_objects line lists "
    "every object the detector currently sees, with a position. A "
    "collective or quantified target is NEVER directly actionable: a "

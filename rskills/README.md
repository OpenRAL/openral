...
| `rskill-moveit-multi-eef_pose-none` / `rskill-moveit-multi-joints-none` / `rskill-moveit-multi-look_at-none` | ros_action (MoveIt) |
| `rskill-nav2-mobile_base-navigate_to_pose-none` | ros_action (Nav2) |

...
# rskill-moveit-multi-eef_pose-none
...
[`rskill-moveit-multi-look_at-none`](../rskill-moveit-look-at/) (gaze is a computed-pose
specialisation) and of [`rskill-moveit-multi-joints-none`](../rskill-moveit-joints/)
...
ros2 action send_goal /openral/execute_rskill openral_msgs/action/ExecuteRskill \
    "{rskill_id: 'OpenRAL/rskill-moveit-multi-eef_pose-none', deadline_s: 30.0, prompt: 'move to pre-grasp',
...
- **No velocity / jerk bound at the supervisor.** Same posture as
  `rskill-moveit-multi-joints-none`: the per-joint position envelope runs per

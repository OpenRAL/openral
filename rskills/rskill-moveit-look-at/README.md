...
# rskill-moveit-multi-look_at-none
...
[`rskill-moveit-multi-joints-none`](../rskill-moveit-joints/), but the goal is a
...
| Field | Value |
| --- | --- |
| `name` | `OpenRAL/rskill-moveit-multi-look_at-none` |
| `version` | `0.1.0` |
| `license` | `apache-2.0` |
| `kind` | `ros_action` |
| `role` | `s1` |
...
ros2 action send_goal /openral/execute_rskill openral_msgs/action/ExecuteRskill \
    "{rskill_id: 'OpenRAL/rskill-moveit-multi-look_at-none', deadline_s: 30.0, prompt: 'look at the mug',

...
# rskill-smolvla-so101-pick_place_pen-bf16
...
This package wraps
[`OpenRAL/rskill-smolvla-so101-pick_place_pen-bf16`](https://huggingface.co/OpenRAL/rskill-smolvla-so101-pick_place_pen-bf16)
...
uv run openral rskill install OpenRAL/rskill-smolvla-so101-pick_place_pen-bf16
...
| Field | Value |
| --- | --- |
| Weights repo | [`OpenRAL/rskill-smolvla-so101-pick_place_pen-bf16`](https://huggingface.co/OpenRAL/rskill-smolvla-so101-pick_place_pen-bf16) (mirror; clean config) |
...
(`OpenRAL/rskill-smolvla-so101-pick_place_pen-bf16`) **strips that one key at rest**,
...
REPO = "OpenRAL/rskill-smolvla-so101-pick_place_pen-bf16"
